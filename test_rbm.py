...
from rb_semilinear.sl_problems import Fisher_mms, Fisher, SemilinearPoisson, MySemilinearProblem
...
hf_problem:MySemilinearProblem = testproblems[test_problem](N_h=N_h, solver=solver, 
